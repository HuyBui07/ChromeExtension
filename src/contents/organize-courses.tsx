...
import { SortCoursesSettingName } from "~src/options/components/moodle/courseSortCoursesOptions"
...
SettingWatcher.get(SortCoursesSettingName).then((sortCourseEnabled) => {
  if (sortCourseEnabled === "true") {
    OrganizeCoursesCS()
  }
})
